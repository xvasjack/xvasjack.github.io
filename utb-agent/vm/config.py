...
def _validate_ws_url(url: str) -> str:
    ...
    try:
        ...
        return "ws://localhost:3001/agent"
...
class AgentConfig:
    ...
    host_ws_url: str = "ws://localhost:3001/agent"
...
def load_config():
    ...
    raw_ws_url = os.environ.get("HOST_WS_URL", "ws://localhost:3001/agent")
